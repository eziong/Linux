...
__param(int, nnodes, 100000, "Number of nodes in the rb-tree");
__param(int, perf_loops, 1, "Number of iterations modifying the rb-tree");
...
static int __init rbtree_test_init(void)
{
	...
	printk(KERN_ALERT "rbtree testing (inserting, deleting, traversing 100000 nodes)");
	...
	printk(" -> test 1 (execution time of nnodes insert): %ldus \n", time);
	...
	printk(" -> test 1 (execution time of nnodes delete): %ldus \n", time);
	...
	printk(" -> test 3 (execution time of inorder traversal): %ldus \n", time);
